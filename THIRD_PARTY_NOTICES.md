...
Sakutio redistributes `ffmpeg-core.js` and `ffmpeg-core.wasm` from the official
`@ffmpeg/core@0.12.10` npm package. For a public release, do not rely only on an
